...
function getImgJson(p) {
    var imgJson = [];
    if ("undefined" !== eval("typeof w" + p + "imgJsons"))eval("imgJson = w" + p + "imgJsons"); else {
        ...
        return this.each(function () {
            ...
            if (null !== d.json ? e = d.json : null !== d.p && (e = getImgJson(d.p)), e.length > 0) {
                ...
                return a.each(g, function (b, c) {
                    c = c.replace(/<!--[\s\S]*?-->/g, ""), h[b] = "", a.each(e, function (a, d) {
    ...
    a.fn.sudyTouch = function (b) {
        return this.each(function () {
            a(this).width(), a(this).height(), a(this).on("touchstart", function (c) {
                ...
                var d = c.originalEvent.touches[0], e = Number(new Date), f = d.pageX - a.data(this, "touchstart").posX, g = d.pageY - a.data(this, "touchstart").posY;
                ...
                var c = Number(new Date), d = a.data(this, "touchmove").posX - a.data(this, "touchstart").posX, f = a.data(this, "touchmove").posY - a.data(this, "touchstart").posY, g = c - a.data(this, "touchstart").timer;
...
!function ($) {
    $.fn.sudyfocus = function (opts) {
        function setfoucs(a) {
            $.each(a, function (a, b) {
                if ("img_meta" in o.json[a] && !$.isEmptyObject(o.json[a].img_meta)) {
                    var c = $(b).find("img").eq(0), d = o.json[a].img_meta.focusWidth, e = o.json[a].img_meta.focusHeight, f = d / e, g = o.json[a].img_meta.realWidth, h = o.json[a].img_meta.realHeight, i = g / h, j = {
        ...
        var defaults = {
            p: null,
            json: [],
            title: {active: !0, isAutoWidth: !1, href: !1},
            text: {active: !1, isAutoHeight: !1, href: !1},
            href: !0,
            zWidth: 420,
            zHeight: 270,
            response: !0,
        ...
        return null !== o.p && "function" == eval("typeof getImgJson") && (o.json = getImgJson(o.p).concat(o.json)), this.each(function () {
            function n() {
                a.css({width: zW + "px", height: zH + "px"}).addClass("focus-box"), d.css({
                    width: zW + "px",
                    height: zH + "px",
                    visibility: "visible"
                })
            ...
            function u() {
                ...
                var a = $.trim(o.json[q].title || ""), b = $.trim(o.json[q].text || "");
            ...
            if ($.each(b, function (a, b) {
                    ...
                    return $.each(o.json, function () {
                        b += '<img src="' + (this.original == undefined ? this.src : this.original) + '">'
                    }), b
            ...
            var d = $(".focus-container", a), e = $(".focus-item", d).hide(), f = e.length;
            ...
            var g = $(".focus-title-bar", a), h = $(".focus-text-box", a), i = $(".focus-navigation", a), j = $(".focus-pagination", a), k = $(".focus-page", j), l = $(".focus-title", g), m = $(".focus-text", h);
            ...
            n(), setfoucs(e);
            var q = o.start > f ? f - 1 : o.start - 1, s = q, t = {
                show: function () {
                    e.eq(s).hide().end().eq(q).show()
                }, slide: function () {
                    function a() {
                        e.eq(q).css({left: "100%"}), e.eq(s).stop(!0, !0).animate({left: "-100%"}, o.speed), e.eq(q).stop(!0, !1).animate({left: "0%"}, o.speed)
                    }
            ...
            o.autoPlay && x();
            var y = $(".focus-prev", a), z = $(".focus-next", a);
            y.click(function () {
                w()
            }), z.click(function () {
                v()
            }), k.on(o.trigger, function () {
                q = $(this).index(), u()
...
!function (a) {
    a.fn.sudySelect = function (b) {
        ...
        return this.each(function () {
            var c = (a(this), a(this).find(d.target)), g = a.trim(c.text()).split(d.separator), h = parseInt(g[d.format.indexOf("\u5e74")], 10), i = parseInt(g[d.format.indexOf("\u6708")], 10), j = parseInt(g[d.format.indexOf("\u65e5")], 10);
        ...
        return this.each(function () {
            var b = a(this), c = b.find(d.handle), e = d.content.split(","), f = d.start - 1, g = c.length, h = f;
            if (a.each(c, function (f, g) {
                    a(g).on(d.trigger, function (d) {
                        return d.preventDefault(), h = f, c.removeClass("selected"), a(this).addClass("selected"), a.each(e, function (a, c) {
                            b.find(c).removeClass("active").hide(), b.find(c).eq(f).addClass("active").show()
                        }), !1
                    })
                }), d.autoPlay.active) {
        ...
        var c = {
            ...
            var a = new Date, b = a.getFullYear(), c = a.getMonth() + 1, f = a.getDate(), g = a.getHours(), h = a.getMinutes(), i = a.getSeconds(), j = "cn" == d.week ? ["\u661f\u671f\u65e5", "\u661f\u671f\u4e00", "\u661f\u671f\u4e8c", "\u661f\u671f\u4e09", "\u661f\u671f\u56db", "\u661f\u671f\u4e94", "\u661f\u671f\u516d"][a.getDay()] : ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][a.getDay()], k = "cn" == d.noon ? ["\u4e0a\u5348", "\u4e0b\u5348"][12 > g ? 0 : 1] : ["AM", "PM"][12 > g ? 0 : 1], l = 0;
        ...
        return this.each(function () {
            var h, b = a(this), c = a(this).find(d.handle), e = a(this).find(d.wrap), f = c.outerHeight(), i = e.outerHeight(), f = e.css("bottom");
            "block" == d.width && (b.css("display", "block"), c.css("display", "block")), /\d+/.test(d.width) && (b.css("width", d.width), c.css("display", "block")), "elink" == d.type && e.css("width", b.width() - 2), b.on(d.trigger, function (g) {
                g.preventDefault(), clearTimeout(h);
                var j = b.offset().top, k = a(window).scrollTop(), l = j - k;
                return d.position && (b.css("position", "relative"), i > l ? e.css({
                    ...
                    top: "auto",
                    bottom: f
                })), c.addClass("wrap-open"), "slide" == d.effect ? e.stop(!0, !0).hide().slideDown(d.speed) : "fade" == d.effect ? e.stop(!0, !0).hide().fadeIn(d.speed) : e.show(), !1
            }), b.mouseleave(function (a) {
                return a.preventDefault(), h = setTimeout(function () {
        ...
        return this.each(function () {
            ...
            var b = a(this), c = a(this).children(), e = c.length, f = a(this).parent(), g = "scroll-" + Number(new Date), h = Math.ceil(e / d.step), i = 0, j = 0, k = 0;
            d.step = d.step > d.display ? d.display : d.step, f.wrap('<div class="sudy-scroll" id="' + g + '">');
            var l = a(this).parent().parent();
            if ("x" == d.dir ? (l.css({width: d.width * d.display + "px"}), f.css({width: d.width * d.display + "px"}), b.css({
                    width: d.width * e + "px",
                    position: "absolute",
                    left: "0px",
                    top: "0px"
                ...
                })) : (l.css({height: d.height * d.display + "px"}), f.css({height: d.height * d.display + "px"}), b.css({
                    position: "absolute",
                    left: "0px",
                    top: "0px"
                }), c.css({height: d.height + "px"})), d.navigation && l.append('<div class="sudy-scroll-nav"><a href="javascript:;" class="nav-prev">&lt;</a><a href="javascript:;" class="nav-next">&gt;</a></div>'), d.pagination) {
